...
class Person {
    ...
    age;
    height;
    static heightMeasureUnits = HeightUnits.CENTIMETRES;
    weight;
    static WeightMeasureUnits = WeightUnits.KILOGRAMS;
    constructor({ name, surname, age, height, heightMeasureUnits, weight, WeightMeasureUnits, }) {
        this.name = name;
